        ...
        async with aiosqlite.connect(self.path) as db:
            await db.executescript("""
                ...
                CREATE TABLE IF NOT EXISTS guild_config (
                    ...
                    welcome_channel2_id INTEGER DEFAULT 0,
                    welcome_message2    TEXT    DEFAULT '',
                    welcome_image_url2  TEXT    DEFAULT '',
                ...
                CREATE TABLE IF NOT EXISTS tickets_config (
                    ...
                    panel_description      TEXT    DEFAULT 'Selecione uma categoria abaixo para abrir um ticket privado com a equipe.',
                    ticket_title           TEXT    DEFAULT '🎫 Ticket de {user}',
                    ticket_description     TEXT    DEFAULT 'Olá, {user}! Descreva sua situação e a equipe irá ajudar.',
                    close_message          TEXT    DEFAULT '🔒 Ticket fechado por {closer}. Este canal será deletado em 5 segundos.',
                    cat_duvidas_enabled    INTEGER DEFAULT 1,
                    cat_duvidas_label      TEXT    DEFAULT '❓ Dúvidas',
                    cat_duvidas_desc       TEXT    DEFAULT 'Tire suas dúvidas com a equipe',
                    cat_parcerias_enabled  INTEGER DEFAULT 1,
                    cat_parcerias_label    TEXT    DEFAULT '🤝 Parcerias',
                    cat_parcerias_desc     TEXT    DEFAULT 'Proposta de parceria com o servidor',
                    cat_outros_enabled     INTEGER DEFAULT 1,
                    cat_outros_label       TEXT    DEFAULT '💬 Outros',
                    cat_outros_desc        TEXT    DEFAULT 'Outros assuntos e solicitações'
                );
            ...
            migrations = [
                ...
                "ALTER TABLE tickets_config ADD COLUMN panel_description TEXT DEFAULT 'Selecione uma categoria abaixo para abrir um ticket privado com a equipe.'",
                "ALTER TABLE tickets_config ADD COLUMN ticket_title TEXT DEFAULT '🎫 Ticket de {user}'",
                "ALTER TABLE tickets_config ADD COLUMN ticket_description TEXT DEFAULT 'Olá, {user}! Descreva sua situação e a equipe irá ajudar.'",
                ...
                "ALTER TABLE tickets_config ADD COLUMN cat_duvidas_enabled INTEGER DEFAULT 1",
                "ALTER TABLE tickets_config ADD COLUMN cat_duvidas_label TEXT DEFAULT '❓ Dúvidas'",
                "ALTER TABLE tickets_config ADD COLUMN cat_duvidas_desc TEXT DEFAULT 'Tire suas dúvidas com a equipe'",
                "ALTER TABLE tickets_config ADD COLUMN cat_parcerias_enabled INTEGER DEFAULT 1",
                "ALTER TABLE tickets_config ADD COLUMN cat_parcerias_label TEXT DEFAULT '🤝 Parcerias'",
                "ALTER TABLE tickets_config ADD COLUMN cat_parcerias_desc TEXT DEFAULT 'Proposta de parceria com o servidor'",
                "ALTER TABLE tickets_config ADD COLUMN cat_outros_enabled INTEGER DEFAULT 1",
                "ALTER TABLE tickets_config ADD COLUMN cat_outros_label TEXT DEFAULT '💬 Outros'",
                "ALTER TABLE tickets_config ADD COLUMN cat_outros_desc TEXT DEFAULT 'Outros assuntos e solicitações'",
                "ALTER TABLE guild_config ADD COLUMN welcome_channel2_id INTEGER DEFAULT 0",
                "ALTER TABLE guild_config ADD COLUMN welcome_message2 TEXT DEFAULT ''",
                "ALTER TABLE guild_config ADD COLUMN welcome_image_url2 TEXT DEFAULT ''",
                "ALTER TABLE guild_config ADD COLUMN welcome_dm_enabled INTEGER DEFAULT 1",
